...
public class UserController {
    ...
    public ResponseEntity<LibraryBookResponse> addBookToLibrary(@PathVariable Long userId, @Valid @RequestBody AddBookToLibraryRequest addBookToLibraryRequest){
        LibraryBookResponse libraryBookResponse = libraryService.addBookToLibrary(userId, addBookToLibraryRequest);

        return ResponseEntity.status(HttpStatus.CREATED).body(libraryBookResponse);
    }
